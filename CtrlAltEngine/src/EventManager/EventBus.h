 ...
 *
 * Publish-Subscribe pattern is used to notify multiple objects about events. The EventBus class is responsible for managing event subscriptions and emitting events.
 * 
